(function(){
    ...
    function onDomReadyFunction(e){
        ...
        if(location.host === 'vm.vnexpress.net'){
            ...
            try{
                document.getElementById('VM2020_SM_1920x270').querySelector('iframe').style.position = "relative";
                document.getElementById('VM2020_SM_1920x270').querySelector('iframe').style.left = "50%";
                document.getElementById('VM2020_SM_1920x270').querySelector('iframe').style.transform = "translateX(-50%)";
                document.getElementById('VM2020_SM_1920x270').querySelector('iframe').style.maxWidth = "unset";
            }catch(e){}
        }

        if((location.host === 'vnexpress.net' || location.host === 'wcoin.fpt.com' || location.host === 'beta.vnexpress.net') && _detectMobile == true)
        {
            try{                
            ...
            //control style lai css new vi tri asd>iframe
            try{
                document.getElementById("VN_PC_Vne_MH_970x250").querySelectorAll('iframe')[0].maxWidth = 'none !important;';  
            }catch(e){}
    ...
    function onShowBtnClose()
    {
        try{
            ...
            let __devQuery = document.querySelector('div[id*="SA_728x90"]') || document.querySelector('div[id*="SA_320x50"]') || document.querySelector('div[id*="SB_1000x100"]') || document.querySelector('div[id*="SB_728x90"]');
    ...
    function updateStickyBanner()
    {
        ...
        {           
            ...
            //oversea - redesign
            try{
                document.querySelector('div[id*="SB_728x90"]').style.position = 'fixed';
                document.querySelector('div[id*="SB_728x90"]').style.bottom = '0';
                document.querySelector('div[id*="SB_728x90"]').style.left = '50%';
                document.querySelector('div[id*="SB_728x90"]').style.transform = 'translateX(-56%)';
                document.querySelector('div[id*="SB_728x90"]').style.zIndex = '999999999';
                onShowBtnClose();
               
            }catch(e){} 
            try{
                document.querySelector('div[id*="SFB_728x90"]').style.position = 'fixed';
                document.querySelector('div[id*="SFB_728x90"]').style.bottom = '0';
                document.querySelector('div[id*="SFB_728x90"]').style.left = '50%';
                document.querySelector('div[id*="SFB_728x90"]').style.transform = 'translateX(-56%)';
                document.querySelector('div[id*="SFB_728x90"]').style.zIndex = '999999999';
                onShowBtnClose();
               
            }catch(e){} 

            
            if(location.host === "demo.vnexpress.net" || location.host === "beta.vnexpress.net")
            {
                //float-left
                try{
                    var __fl = document.querySelector('div[id*="FL_160x600"]');               
                    __fl.style.position = 'fixed';
                    //__fl.style.bottom = '0';
                    __fl.style.top = "calc((100% - 600px))"; //do đang quy hoạch chồng 2 vi trí slider - float
                    __fl.style.left = "calc((100% - 1130px)/2 - 170px)";                
                    __fl.style.zIndex = '999999999';               
                }catch(e){} 
                 //float-right
                try{
                    var __fr = document.querySelector('div[id*="FR_160x600"]');               
                    __fr.style.position = 'fixed';
                    //__fr.style.bottom = '0';
                    __fr.style.top = "calc((100% - 600px))"; // //do đang quy hoạch chồng 2 vi trí slider - float
                    __fr.style.right = "calc((100% - 1130px)/2 - 170px)";                
                    __fr.style.zIndex = '999999999';               
                }catch(e){} 

               // console.log("update css float-left / float-right", __fl, __fr);
            }
            

            //update supper_masthead redesign
            try{
                var __mh = document.getElementById("supper_masthead");
                __mh.style.width = '100%';
                __mh.style.display = 'flex';
                __mh.style.justifyContent = 'center';     
            }catch(e){}
    ...
    function onMessageReceivedGetStyle(e) { 
        ...
        try{
            ...
            if(msgType === 'dfp-background-sync-u'){                               
                onStyleBgU(msgSize,e.data.trackingCode);            
            }
    ...
    function onStyleBgU($size, $trackingCode)
    {        
        var _locationPath = (location.href).replace(location.search,'');  
        var _wrapperEl = document.getElementById("background_left_right");
        if (_wrapperEl){
            //trang MVOT /  JOOLUX > nhan biet bang id background_left_right # voi id sync_bgu_and_masthead danh cho bg_u
            //_locationPath = (location.href).replace(location.search,''); 
            //var _locationMVOT = _locationPath.indexOf("goc-thuong-hieu");
            //var _locationJOOLUX = _locationPath.indexOf("song-sanh-dieu");
            //if(_locationMVOT != -1 || _locationJOOLUX != -1){
               // console.log('background_left_right ', document.getElementById('background_left_right').querySelectorAll('iframe')[0]);
                try{
                    //giao diện cũ.
                    _elmIfr = document.getElementById('background_left_right').querySelectorAll('iframe')[0];
                    _elmIfr.style.position = 'fixed';
                    _elmIfr.style.top = '0';
                    _elmIfr.style.left = '0';
                    _elmIfr.style.width = '100%';
                    _elmIfr.style.height = '100%';
                    _elmIfr.style.zIndex = '-1';                
                }catch(e){};   
                if(!document.getElementById('bgWhite')){
                    document.getElementById('background_left_right').querySelector('div').insertAdjacentHTML('beforeend','<div id="bgWhite" style="width:100vw;height:100vh;max-width:1020px;z-index:-1;position:fixed;top:0px;left:50%;transform:translateX(-50%);background-color:#fff"></div>');
                }        
            //}  
        }else{

            _wrapperEl = document.getElementById("sync_bgu_and_masthead") || document.getElementById('background_sync_u') || document.getElementById('sync_bgu_and_masthead');
			...
			var _locationSub5 =_locationPath.indexOf("kinh-te-dem");
            ...
            if(location.host === 'demo.vnexpress.net' || location.host === 'wcoin.fpt.com' || location.host === 'vnexpress.net' || location.host === 'beta.vnexpress.net'){  
               ...
               try{
                    document.getElementsByClassName("section_topstory")[0].children[0].style.backgroundColor = '#fff';
                }catch(e){}
                ...
                }else if(_hTOP == "0px"){_hTOP = 0;_hTOPBG = 0;
                ...
                try{_elmIfr = document.getElementById('sync_bgu_and_masthead').querySelectorAll('iframe')[0];  
                    _elmIfr.style.position = 'absolute';
                ...
                if(!document.getElementById('bgWhite')){
                    document.getElementById('sync_bgu_and_masthead').querySelector('div').insertAdjacentHTML('beforeend','<div id="bgWhite" class="bgWhite" style="width:100vw;height:100vh;max-width:1130px;z-index:0;position:absolute;top:'+_hTOPBG+'px;left:50%;transform:translateX(-50%);background-color:#fff"></div>');                    
                    document.getElementById('sync_bgu_and_masthead').querySelector('div').insertAdjacentHTML('beforeend','<a id="bgTranparentLeft" class="clickTracking" style="width:calc((100% - 1130px)/2);height:100vh;max-width:1130px;z-index:9999999;position:absolute;top:'+_hTOPBG+'px;left:0;background-color:transparent" href="'+decodeURIComponent($trackingCode)+'" target="_blank"></a>');
                    document.getElementById('sync_bgu_and_masthead').querySelector('div').insertAdjacentHTML('beforeend','<a id="bgTranparentRight" class="clickTracking" style="width:calc((100% - 1130px)/2);height:100vh;max-width:1130px;z-index:9999999;position:absolute;top:'+_hTOPBG+'px;right:0;background-color:transparent" href="'+decodeURIComponent($trackingCode)+'" target="_blank"></a>');
                }
                ...
                window.onscroll = function(){
                    ...
                    if(document.body.scrollTop > _hTOPBG || document.documentElement.scrollTop > _hTOPBG)
                    {
                        ...
                        var div_list = document.querySelectorAll('.clickTracking');
